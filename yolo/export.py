...
def export_engine(model, im, file, train, half, simplify, workspace=4, verbose=False, skip_onnx=False, prefix=colorstr('TensorRT:')):
...
def run(
        ...
        skip_onnx=False, # TRT: skip onnx gen
    ...
    if engine:  # TensorRT required before ONNX
        f[1] = export_engine(model, im, file, train, half, simplify, workspace, verbose, skip_onnx)
...
def parse_opt():
    ...
    parser.add_argument('--skip_onnx', action='store_true', help='TRT: skip generation of onnx model')    
